        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
              <a class="navbar-brand  py-0 my-0" href="<?php echo e(route('home')); ?>">
                <p class="text-center py-0 my-0 text-secondary">El Desquite</p>
              </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto ">
                      ...
                      <?php if(\Shinobi::can('roles.index') || \Shinobi::can('users.index')): ?>
                         <a class="nav-link dropdown-toggle <?php echo e(strpos(request()->path(),'sers')|| strpos(request()->path(),'oles')? 'active': ''); ?>"
